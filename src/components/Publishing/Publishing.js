  ...
  return (
    <div className="relative">
      <video
        ...
        loop
      />
      <div className="absolute inset-0 z-40 flex flex-col justify-center items-center text-center top-0 left-0 mb-72 md:mb-96 md:left-20 w-full md:w-1/2 h-full font-sans">
