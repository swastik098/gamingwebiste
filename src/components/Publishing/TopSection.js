  ...
  return (
    <div className="relative">
      <video
        ...
        loop
      />
      <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center absolute top-0 left-0 w-1/2 h-full">
      ...
      <div className="absolute absolute top-0 right-0 w-1/2 h-full">
      <RegisterForm />
      </div>
    </div>
//     <div className="relative">
