...
const Academy = () => {
  return (
    <div className="flex flex-col h-screen md:flex-row justify-between w-full text-center mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap justify-center md:w-1/2 border-spacing-4 mt-8">
