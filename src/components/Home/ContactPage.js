...
const ContactPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 bg-grey-500 rounded-lg m-6 font-sans contact_us">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className=" flex justify-center items-center">
          <button
            type="submit"
            className="bg-white hover:bg-blue text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Contact Us
          </button>
        </div>
